            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            No customers will be allowed to book hotel rooms when shutodown mode is turned On.
                        </p>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <iframe id="iframe" class="border p-2 m-100" loading="lazy"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function add_member()
        {
            ...
            xhr.onload = function(){
                ...
                else if(this.responseText == 'inc_size'){
